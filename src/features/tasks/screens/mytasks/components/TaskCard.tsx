...
const styles = StyleSheet.create({
  ...
  title: {
    ...
    color: '#1a1a1a',
    lineHeight: isTablet ? RFValue(20) : RFValue(20),
  },
  metaRow: {
    flexDirection: 'row',
    alignItems: 'center',
    marginBottom: isTablet ? hp('0.6%') : hp('0.5%'),
    flexWrap: 'wrap',
  ...
  locationDivider: {
    marginHorizontal: isTablet ? wp('1.5%') : wp('1.5%'),
    color: '#ccc',
    fontSize: RFValue(12),
  },
  locationText: {
  ...
  meta: {
    ...
    justifyContent: 'space-between',
    alignItems: 'center',
    marginTop: isTablet ? hp('0.6%') : hp('0.5%'),
  },
  status: {
  ...
  userAvatar: {
    width: isTablet ? wp('11%') : wp('8%'),
    height: isTablet ? wp('11%') : wp('8%'),
    borderRadius: isTablet ? wp('5.5%') : wp('4%'),
    backgroundColor: '#f0f0f0',
  },
  description: {
    fontSize: RFValue(isTablet ? 13 : 14),
    color: '#555',
    lineHeight: isTablet ? RFValue(18) : RFValue(20),
    marginTop: isTablet ? hp('0.8%') : hp('1%'),
  },
  categoryContainer: {
    flexDirection: 'row',
    alignItems: 'center',
    flexWrap: 'wrap',
    gap: isTablet ? wp('1.5%') : wp('2%'),
    marginTop: isTablet ? hp('1%') : hp('1.2%'),
    paddingTop: isTablet ? hp('0.8%') : hp('1%'),
    borderTopWidth: 1,
  ...
  categoryLabel: {
    ...
    color: '#4a5568',
    fontWeight: '600',
    lineHeight: isTablet ? RFValue(16) : RFValue(18),
  },
  categoryTag: {
    backgroundColor: '#e3f2fd',
    paddingHorizontal: isTablet ? wp('2%') : wp('2%'),
  ...
  moreCategoriesText: {
    ...
    fontWeight: '500',
    fontStyle: 'italic',
    marginLeft: isTablet ? wp('0.5%') : wp('1%'),
  },
  posterCancelOverlay: {
    flex: 1,
    backgroundColor: 'rgba(0, 0, 0, 0.5)',
